...
import { Activity, Eye, EyeOff, Mail, Lock, User, ArrowRight, Building, ArrowLeft } from 'lucide-react'
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast(error.message || 'Connection error. Please check if backend is running.', 'error')
    } finally {
      setIsLoading(false)
    }
  }
      ...
      >
        ...
        <GlassCard className="p-8">
          <div className="mb-8 text-center">
            <h1 className="text-2xl font-semibold text-white/90 mb-2">Create your account</h1>
            <p className="text-sm text-white/60">Start managing your operations in minutes</p>
          </div>
            ...
            <div className="pt-2">
              <label className="flex items-start gap-3 cursor-pointer group">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 rounded bg-white/5 border border-white/20 text-accent focus:ring-2 focus:ring-accent/50 cursor-pointer"
                />
